    ...
    <div class="container">
        <div ref="login" class="box login">
            <div class="form-content">
                <div class="avtar">
                    <div class="pic"><img src="../assets/img/img-l-1.jpg" alt=""></div>
                </div>
                <h1>Welcome back</h1>
                ...
                <p class="btn-something">
                    Don't have an account ? <span ref="tosignup" class="signupbtn" @click="toSignup">signup</span>
                </p>
            </div>
        </div>
        <div ref="signup" class="box signup">
            <div class="form-content">
                <div class="avtar">
                    <div class="pic"><img src="../assets/img/img-l-2.jpg" alt=""></div>
                </div>
                ...
                <p class="btn-something">
                    Already have an account ? <span ref="tosignin" class="loginbtn" @click="toSignin">login</span>
                </p>
            </div>
        </div>
    </div>
